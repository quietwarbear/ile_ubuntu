    ...
    <div className="min-h-screen bg-[rgb(var(--ink-deep))]">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <div className="prose prose-invert max-w-none text-[rgb(var(--text-softer))] text-[15px] leading-relaxed space-y-6">
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>2. Information We Collect</h2>

            <h3 className="text-lg text-[rgb(var(--text-soft))] mt-4 mb-2">Personal Information</h3>
            ...
            <h3 className="text-lg text-[rgb(var(--text-soft))] mt-4 mb-2">Usage Information</h3>
            ...
            <h3 className="text-lg text-[rgb(var(--text-soft))] mt-4 mb-2">Payment Information</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>4. Information Sharing</h2>
            <p>We do not sell your personal information. We may share your information with:</p>
            <ul className="list-disc pl-6 space-y-1 text-[rgb(var(--text-muted))]">
              <li><strong className="text-[rgb(var(--text-soft))]">Service Providers:</strong> Third-party services that help us operate the platform (e.g., MongoDB for data storage, Resend for email, Stripe and Apple for payments, RevenueCat for subscription management, Jitsi for video conferencing).</li>
              <li><strong className="text-[rgb(var(--text-soft))]">Other Users:</strong> Your display name, role, and profile photo may be visible to other users within courses, cohorts, community forums, and knowledge spaces you participate in.</li>
              <li><strong className="text-[rgb(var(--text-soft))]">Legal Requirements:</strong> We may disclose information if required by law, regulation, or legal process.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>5. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>6. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>7. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>8. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>9. Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>10. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-[rgb(var(--text-main))] mb-3" style={{ fontFamily: 'Cormorant Garamond, serif' }}>11. Contact Us</h2>
