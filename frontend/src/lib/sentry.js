...
// replay records the screen/DOM and the commons serves minors and students.
// No-op unless REACT_APP_SENTRY_DSN is set at build time, mirroring how the
// backend is gated on SENTRY_DSN.
...
export function initSentry() {
  ...
  try {
    ...
    console.warn("[Ile Ubuntu] Sentry init skipped:", err?.message || err);
  }
}
